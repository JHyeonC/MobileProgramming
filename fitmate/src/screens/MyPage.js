...
import { Image, StyleSheet, View, Text, TouchableHighlight, Dimensions, TextInput } from "react-native";
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerText} onPress={() => navigation.navigate("MenuBar")}>FIT MATE</Text>
      </View>
      <View style={styles.nameBar}>
        <View style={styles.imageContainer}>
          <Image source={require("../image/icongray.png")} style={styles.image} />
        </View>
        <View style={styles.textContainer}>
          <Text style={styles.nameBarText}>성유진 회원님</Text>
        </View>
        <View style={styles.bubbleContainer}>
          <View style={styles.bubbleTriangle} />
          <View style={styles.bubble}>
            <Text style={styles.bubbleText}>성유진 회원님의 목표 체중은 "{goalWeight} kg"입니다.</Text>
          </View>
        </View>
      </View>
      <View style={styles.goalBar}>
      <View style={styles.tableRow}>
          <Text style={[styles.tableText, styles.tableHeaderTitle]}>이번달 목표</Text>
        </View>
        <View style={styles.tableRow}>
          <Text style={[styles.tableText, styles.tableHeader]}>목표 체중</Text>
          <Text style={[styles.tableText, styles.tableHeader]}>하루 칼로리</Text>
